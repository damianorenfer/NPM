...
class ComputersControllerTest < ActionController::TestCase
  ...
  test "should create computer" do
    assert_difference('Computer.count') do
      post :create, computer: { ip_address: @computer.ip_address, mac_address: @computer.mac_address, name: @computer.name }
    end
  ...
  test "should update computer" do
    patch :update, id: @computer, computer: { ip_address: @computer.ip_address, mac_address: @computer.mac_address, name: @computer.name }
    assert_redirected_to computer_path(assigns(:computer))
  end
